...
import { isLogged, toSchedulable, type HabitScheduleFields } from './habitSchedule.js';
 ...
 *
 * - daily/weekdays/interval: consecutive *scheduled* days completed. Non-
...
export function computeStreak(
  ...
  for (const e of habitEntries) if (isLogged(e)) completed.add(dateOnly(e.entryDate));
